...
class Radio:
    ...
    def __init__(self, board, rds_parser, frequency=9310, volume=1):
        self.board = board
        ...
        # saves register values to virtual registers, sets the basic freq, volume
        self.setup()
    ...
    def set_band(self, band):
        ...
        self.band = band
        if (band == "FM" or band == "fm" or band == "Fm"):
    ...
    def check_threshold(self):
        """docstring."""
        # Check if the signal strength is strong enough for receiving rds data
    ...
    def process_data(self, block1, block2, block3, block4):
        ...
        if rds_group_type == 0x0B:
            ...
            if off & 0x20:
                ...
                mins += 30 * (off & 0x1F)
            # Check if function sendTime was set, and check if the time is different
